...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ViewPage = __webpack_require__(154);

	var _ViewPage2 = _interopRequireDefault(_ViewPage);

	var _UploadPage = __webpack_require__(166);
	...
	if (path.indexOf('/upload') == 0) {
	  page = _UploadPage2.default;
	} else if (path.indexOf('/sessions') == 0) {
	  page = _ViewPage2.default;
	} else {
	  throw new Error('unknown page');
	}

	_reactDom2.default.render(_react2.default.createElement(page, window.data), document.getElementById('main'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TranscriptInput = __webpack_require__(155);

	var _TranscriptInput2 = _interopRequireDefault(_TranscriptInput);

	var _ZoomBar = __webpack_require__(156);
	...
	var _KeyListener = __webpack_require__(163);
	...
	var _SessionAPI = __webpack_require__(165);

	var _SessionAPI2 = _interopRequireDefault(_SessionAPI);
	...
	var ViewPage = function (_React$Component) {
	  _inherits(ViewPage, _React$Component);

	  function ViewPage(props) {
	    _classCallCheck(this, ViewPage);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ViewPage).call(this, props));

	    _this.api = new _SessionAPI2.default();
	    ...
	    for (var k in _this.props.session) {
	      _this.state[k] = _this.props.session[k];
	    }

	    var that = _this;

	    var spaceListener = new _KeyListener2.default(32);
	    ...
	    var animateCurrentTime = function animateCurrentTime(t) {
	    ...
	    _this._watchForUpdates = _this._watchForUpdates.bind(_this);
	    _this._watchForUpdates();
	    return _this;
	  }

	  _createClass(ViewPage, [{
	    key: '_watchForUpdates',
	    value: function _watchForUpdates() {
	      var that = this;
	      if (this.isWatching) {
	        return;
	      }
	      ...
	      var watcher = new _SessionWatcher2.default(this.state.id);
	    ...
	    key: 'onTranscript',
	    value: function onTranscript(transcript) {
	      var that = this;
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'a',
	          { href: csvURL, className: 'download-button' },
	          'Download CSV'
	        ),
	        _react2.default.createElement(_ZoomBar2.default, {
	          amount: this.state.zoom,
	          onChange: this.onZoom.bind(this) }),
	        _react2.default.createElement(_TranscriptInput2.default, {
	          disabled: this.state.status !== 'DONE',
	          onSubmit: this.onTranscript.bind(this) }),
	        _react2.default.createElement('audio', { ref: 'player', type: 'audio/wav', src: '/blobs/' + this.state.playback_id + '.wav' })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TranscriptInput = function (_React$Component) {
	  _inherits(TranscriptInput, _React$Component);

	  function TranscriptInput() {
	    _classCallCheck(this, TranscriptInput);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(TranscriptInput).apply(this, arguments));
	  }

	  _createClass(TranscriptInput, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement("textarea", { disabled: this.props.disabled, ref: "textarea" }),
	          _react2.default.createElement("input", { disabled: this.props.disabled, type: "submit" })
	        )
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ZoomBar = function (_React$Component) {
	  ...
	  function ZoomBar(props) {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ZoomBar).call(this, props));
	  ...
	  _createClass(ZoomBar, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        { ref: 'container', onMouseDown: this.onMouseDown, className: 'zoom' },
	        _react2.default.createElement('div', { className: 'indicator', style: { width: percent } }),
	        _react2.default.createElement(
	          'div',
	          { className: 'label' },
	          'zoom'
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PitchScale = __webpack_require__(158);

	var _PitchScale2 = _interopRequireDefault(_PitchScale);

	var _Playhead = __webpack_require__(159);

	var _Playhead2 = _interopRequireDefault(_Playhead);

	var _PitchTrace = __webpack_require__(160);

	var _PitchTrace2 = _interopRequireDefault(_PitchTrace);

	var _Waveform = __webpack_require__(161);

	var _Waveform2 = _interopRequireDefault(_Waveform);

	var _TimedText = __webpack_require__(162);

	var _TimedText2 = _interopRequireDefault(_TimedText);
	...
	var TimelineCharts = function (_React$Component) {
	  _inherits(TimelineCharts, _React$Component);

	  function TimelineCharts() {
	    _classCallCheck(this, TimelineCharts);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(TimelineCharts).apply(this, arguments));
	  }

	  _createClass(TimelineCharts, [{
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(
	        'svg',
	        ...
	        _react2.default.createElement(
	          'g',
	          { className: 'charts', transform: 'translate(' + this.props.paddingLeft + ', 0)' },
	          _react2.default.createElement(_TimedText2.default, {
	          ...
	          _react2.default.createElement(_Waveform2.default, {
	            ...
	            height: 100,
	            scaleX: this.props.scaleX }),
	          _react2.default.createElement(_PitchTrace2.default, {
	            freqHz: this.props.freqHz,
	            transform: 'translate(0, 140)',
	            height: 200,
	            scaleX: this.props.scaleX }),
	          _react2.default.createElement(_Playhead2.default, { currentTime: this.props.currentTime, scaleX: this.props.scaleX })
	        )
	      );
	    }
	  }, {
	    ...
	    value: function _calcWidth() {
	      ...
	      var width = Math.floor(this.props.scaleX * duration + this.props.paddingLeft + this.props.paddingRight);
	      this.refs.canvas.setAttribute('width', width);
	    }
	  }, {
	    key: 'componentDidUpdate',
	    value: function componentDidUpdate(prevProps, prevState) {
	      if (this.props.waveform != prevProps.waveform || this.props.scaleX != prevProps.scaleX) {
	        this._calcWidth();
	      }
	    }
	  }, {
	...
	var Timeline = function (_React$Component2) {
	  ...
	  _createClass(Timeline, [{
	    ...
	    value: function componentDidUpdate(prevProps, prevState) {
	      ...
	      // its own component.
	      if (this.props.playing && !this._isInScroll(this.props.currentTime)) {
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'scales' },
	          _react2.default.createElement(_PitchScale2.default, {
	            height: 200,
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(TimelineCharts, {
	            freqHz: this.props.freqHz,
	            waveform: this.props.waveform,
	            words: this.props.words,
	            scaleX: this._scaleX(),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PitchScale = function (_React$Component) {
	  _inherits(PitchScale, _React$Component);

	  function PitchScale() {
	    _classCallCheck(this, PitchScale);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(PitchScale).apply(this, arguments));
	  }

	  _createClass(PitchScale, [{
	    key: 'shouldComponentUpdate',
	    value: function shouldComponentUpdate(nextProps, nextState) {
	      return this.props.height !== nextProps.height || this.props.minPitch !== nextProps.minPitch || this.props.maxPitch !== nextProps.maxPitch || this.props.tickCount !== nextProps.tickCount || this.props.fontSize !== nextProps.fontSize;
	    }
	  }, {
	    key: '_scaleY',
	    value: function _scaleY(pitch) {
	    ...
	    value: function render() {
	      ...
	      for (var tick = this.props.minPitch; tick <= this.props.maxPitch; tick += tickSize) {
	        ...
	        tickLabels.push(_react2.default.createElement(
	          'text',
	          {
	            key: 'label-' + tick,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Playhead = function (_React$Component) {
	  _inherits(Playhead, _React$Component);

	  function Playhead() {
	    _classCallCheck(this, Playhead);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(Playhead).apply(this, arguments));
	  }

	  _createClass(Playhead, [{
	    key: "shouldComponentUpdate",
	    value: function shouldComponentUpdate(nextProps, nextState) {
	      return this.props.scaleX !== nextProps.scaleX || this.props.currentTime !== nextProps.currentTime;
	    }
	  }, {
	    key: "render",
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        "g",
	        { className: "playhead" },
	        _react2.default.createElement("line", { x1: x, x2: x, y1: "0", y2: "100%" }),
	        _react2.default.createElement(
	          "text",
	          { transform: "translate(" + (x + 5) + ", 10)", fontSize: "12" },
	...
	function timestamp(seconds) {
	  ...
	  return pad(mins, 2) + ':' + pad(secs, 2) + '.' + pad(frac, 2);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PitchTrace = function (_React$Component) {
	  _inherits(PitchTrace, _React$Component);

	  function PitchTrace() {
	    _classCallCheck(this, PitchTrace);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(PitchTrace).apply(this, arguments));
	  }

	  _createClass(PitchTrace, [{
	    key: "shouldComponentUpdate",
	    value: function shouldComponentUpdate(nextProps, nextState) {
	      return this.props.freqHz !== nextProps.freqHz || this.props.scaleX !== nextProps.scaleX || this.props.minPitch !== nextProps.minPitch || this.props.maxPitch !== nextProps.maxPitch || this.props.height !== nextProps.height;
	    }
	  }, {
	    key: "render",
	    value: function render() {
	      ...
	      for (var i = 0; i < data.length; i++) {
	        ...
	        circles.push(_react2.default.createElement("circle", { key: i, r: "1", transform: "translate(" + x + "," + y + ")" }));
	      }

	      return _react2.default.createElement(
	        "g",
	        { className: "pitch-trace", transform: this.props.transform },
	        circles
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Waveform = function (_React$Component) {
	  ...
	  _createClass(Waveform, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        "g",
	        { className: "wave-container", transform: this.props.transform },
	        _react2.default.createElement(
	          "g",
	          { className: "scale", transform: "scale(" + scaleX + "," + scaleY + ")" },
	          _react2.default.createElement(WaveformUnscaled, { waveform: this.props.waveform })
	        )
	      );
	    }
	  }]);
	...
	var WaveformUnscaled = function (_React$Component2) {
	  _inherits(WaveformUnscaled, _React$Component2);

	  function WaveformUnscaled() {
	    _classCallCheck(this, WaveformUnscaled);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(WaveformUnscaled).apply(this, arguments));
	  }

	  _createClass(WaveformUnscaled, [{
	    key: "shouldComponentUpdate",
	    value: function shouldComponentUpdate(nextProps, nextState) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TimedText = function (_React$Component) {
	  _inherits(TimedText, _React$Component);

	  function TimedText() {
	    _classCallCheck(this, TimedText);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(TimedText).apply(this, arguments));
	  }

	  _createClass(TimedText, [{
	    key: "shouldComponentUpdate",
	    value: function shouldComponentUpdate(nextProps, nextState) {
	      return this.props.words !== nextProps.words || this.props.scaleX !== nextProps.scaleX;
	    }
	  }, {
	    key: "render",
	    value: function render() {
	      ...
	      for (var i = 0; i < data.length; i++) {
	        ...
	        words.push(_react2.default.createElement(Word, {
	      ...
	      return _react2.default.createElement(
	        "g",
	        { className: "timed-text", transform: this.props.transform },
	        words
	      );
	    }
	  }]);
	...
	var Word = function (_React$Component2) {
	  ...
	  _createClass(Word, [{
	    key: "shouldComponentUpdate",
	    value: function shouldComponentUpdate(nextProps, nextState) {
	      return this.props.text !== nextProps.text || this.props.transform !== nextProps.transform;
	    }
	  }, {
	    key: "render",
	    value: function render() {
	      return _react2.default.createElement(
	        "g",
	        { className: "word", transform: this.props.transform },
	        _react2.default.createElement("line", { x1: "0", x2: "0", y1: "-100%", y2: "100%" }),
	        _react2.default.createElement(
	          "text",
	          { fontSize: "10", transform: "translate(2, 10)" },
	          this.props.text
	        )
	      );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	function SessionWatcher(sessionID) {
	  ...
	  this.api = new _SessionAPI2.default();
	  this.stopped = false;
	...
	SessionWatcher.prototype._check = function () {
	  this.api.get(this.sessionID).then(function (result) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DragListener = __webpack_require__(169);

	var _DragListener2 = _interopRequireDefault(_DragListener);

	var _FileDialog = __webpack_require__(170);

	var _FileDialog2 = _interopRequireDefault(_FileDialog);

	var _UploadTarget = __webpack_require__(171);
	...
	var UploadPage = function (_React$Component) {
	  ...
	  function UploadPage(props) {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(UploadPage).call(this, props));

	    _this.uploader = new _Uploader2.default();
	    _this.uploader.onchange = function (queue) {
	      _this.setState({ uploads: queue });
	    };

	    var dragListener = new _DragListener2.default();
	    ...
	    dragListener.ondrop = _this._onChoose.bind(_this);
	  ...
	  _createClass(UploadPage, [{
	    key: '_onChoose',
	    value: function _onChoose(files) {
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_FileDialog2.default, {
	          ref: 'dialog',
	          onChoose: this._onChoose.bind(this) }),
	        _react2.default.createElement(_UploadTarget2.default, {
	          dragging: this.state.dragging,
	          onClick: this._onClickUpload.bind(this) }),
	        _react2.default.createElement(_UploadList2.default, { uploads: this.state.uploads })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _UploadAPI = __webpack_require__(168);
	...
	function Uploader() {
	  this.queue = [];
	  this.active = 0;
	  this.uploadAPI = new _UploadAPI2.default();
	...
	Uploader.prototype._work = function () {
	  ...
	  this.uploadAPI.post(upload.file).then(function (result) {
	    ...
	    watcher = new _SessionWatcher2.default(upload.id);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FileDialog = function (_React$Component) {
	  _inherits(FileDialog, _React$Component);

	  function FileDialog() {
	    _classCallCheck(this, FileDialog);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(FileDialog).apply(this, arguments));
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UploadTarget = function (_React$Component) {
	  _inherits(UploadTarget, _React$Component);

	  function UploadTarget() {
	    _classCallCheck(this, UploadTarget);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(UploadTarget).apply(this, arguments));
	  }

	  _createClass(UploadTarget, [{
	    key: 'render',
	    value: function render() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _UploadRow = __webpack_require__(173);

	var _UploadRow2 = _interopRequireDefault(_UploadRow);
	  ...
	  _createClass(UploadList, [{
	    ...
	    value: function render() {
	      var rows = this.props.uploads.map(function (upload) {
	        return _react2.default.createElement(_UploadRow2.default, { upload: upload });
	      });
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'tr',
	              null,
	              _react2.default.createElement('th', { className: 'timestamp-header' }),
	              _react2.default.createElement(
	                'th',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UploadRow = function (_React$Component) {
	  _inherits(UploadRow, _React$Component);

	  function UploadRow() {
	    _classCallCheck(this, UploadRow);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(UploadRow).apply(this, arguments));
	  }

	  _createClass(UploadRow, [{
	    key: 'render',
	    value: function render() {
